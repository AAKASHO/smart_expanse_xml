...
public final class BudgetDao_Impl implements BudgetDao {
  ...
  public BudgetDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBudget = new EntityInsertionAdapter<Budget>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `budgets` (`id`,`monthlyLimit`,`month`,`year`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfBudget = new EntityDeletionOrUpdateAdapter<Budget>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `budgets` SET `id` = ?,`monthlyLimit` = ?,`month` = ?,`year` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Flow<Budget> getBudget(final int month, final int year) {
      ...
      public Budget call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Budget(_tmpId,_tmpMonthlyLimit,_tmpMonth,_tmpYear);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<Budget> getLatestBudget() {
    final String _sql = "SELECT * FROM budgets ORDER BY year DESC, month DESC LIMIT 1";
